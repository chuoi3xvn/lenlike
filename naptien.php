...
<div class="panel panel-primary">
      <div class="panel-heading">Nạp Tiền Vào Tài Khoản</div>
...
<div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-lg-10">
      ...
      <input type="text" class="form-control" id="txtuser" name="txtuser" value="<?php echo $_SESSION[user];?>" />
  ...
  <div class="form-group">
    ...
    <div class="col-lg-offset-2 col-lg-10">
      ...
      <button type="submit" class="btn btn-primary" name="napthe">Chưa Cấu Hình Đừng Sử Dụng. LH Admin Để Nạp</button>
